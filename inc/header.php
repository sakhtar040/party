...
.navbar-default .navbar-brand {
  color:#DDBE42; font-size:22px; letter-spacing: 2px; font-family: 'Swanky and Moo Moo', cursive;
}
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
 ...
 <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php" style="color:#DDBE42;">THE OFFICE OF ASHWINI 
      KUMAR CHOUBEY</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li id="home" class="active"><a href="home" id="yut">About Us</a></li>
        <li id="timeline"><a href="timeline" id="yut">BIOGRAPHY</a></li>
        <li id="activity"><a href="activity" id="yut">Activity</a></li>
        <li id="press"><a href="press" id="yut">Press</a></li>
        <li id="gallery"><a href="gallery" id="yut">Gallery</a></li>
        <li id="contact"><a href="contact" id="yut">Contact Us</a></li>
        <li>
        <div class="dropdown">
          <button class="dropbtn">Language</button>
            <div class="dropdown-content">
               <a href="home">English</a>
                <a href="hindi/home">Hindi</a>
            </div>
        </div></li>
