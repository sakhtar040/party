...
.input-group-addon{border-radius: 0px;} 
       ...
       <?php 
         $result=mysqli_query($conn, "select * from slider_content_en");//change type
...
<div id="carousel" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner carousel-zoom">
      ...
      <?php
           $result=mysqli_query($conn, "select * from slider_content_en");
           $rowcount=mysqli_num_rows($result);//total records check  
           if($rowcount>0){
           $i=0;
           while(  $row = mysqli_fetch_assoc($result)){
        ...
        <div class="<?php if($i==0){echo 'active';} ?> item"> 
            ...
            <iframe  width="100%" height="550" src="<?=$row['link']?>" frameborder='0' allow='autoplay; encrypted-media' allowfullscreen></iframe>
     ...
     <div class="container">
       <div class="row">
         ...
         <div class="col-lg-8">
           ...
           <div class="row">
            <h2 class="title-widget-sidebar">// MORE VIDEO'S FROM <img src="logo/logorp.png" style="height:18px; width:150px;background-image: center center;"> CHANNEL</h2>
        ...
        <p class="des">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
         ...
         <div class="text-left">
             ...
             <p class="des">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
               ...
               <div class="col-lg-6 col-md-6">
             <aside>
                 <iframe width="100%" height="270" src="http://raidpipe.com/embed/index.php/2" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                <div class="content-title">
        <div class="text-left">
        <h4><a href="#">Lorem Ipsum is simply dummy text.</a></h4>
        <p class="des">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
               ...
               <div class="col-lg-6 col-md-6">
             <aside>
                 <iframe width="100%" height="270" src="http://raidpipe.com/embed/index.php/3" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                <div class="content-title">
        <div class="text-left">
        <h4><a href="#">Lorem Ipsum is simply dummy text.</a></h4>
        <p class="des">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
