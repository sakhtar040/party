...
hr.fancy-line { 
    ...
    <div class="row">
      <div class="col-md-12 ">
      <CENTER style="color: black; font-weight: bold; font-size: 20px;font-family: 'Roboto', sans-serif; letter-spacing: 3PX; padding-bottom: 40PX;">JOURNEY </CENTER>
    </div>
        <div class="col-md-12">
            <div class="main-timeline">
                <div class="timeline">
                    ...
                    <div class="timeline-content">
                        ...
                        <h5 class="title text-left">Born on 2 January 1953 in Bhagalpur, Bihar</h5>
                        <hr class="fancy-line">
                        <p class="description">
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-content">
                      <img src="logo/profile-16.jpg" class="img-responsive text-center">
                        <h5 class="title text-left">Became the worker of the Akhil Bharatiy Vidhyarthi Parishad</h5>
                        <hr class="fancy-line">
                        <p class="description">
