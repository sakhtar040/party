            ...
            <div class='col-md-4 '>
                <a class="thumbnail fancybox list-quotes" rel="ligthbox" href="logo/gallery-1.jpg">
                    ...
                    <div class='text-center quotes'>
                        <p class='text-muted' >छवि शीर्षक</p>
                    </div> <!-- text-center / end -->
                </a>
            </div> <!-- col-6 / end -->
            <div class='col-md-4 '>
                <a class="thumbnail fancybox list-quotes" rel="ligthbox" href="logo/gallery-2.jpg">
                    ...
                    <div class='text-center quotes'  >
                        <p class='text-muted' >  भारत ने लोकतंत्र के लिए 'बहुत अधिक लागत' का भुगतान किया, एनआईटीआई आयोग भारत ने लोकतंत्र के लिए 'बहुत अधिक लागत' का भुगतान किया, एनआईटीआई अयोध इंडिया ने लोकतंत्र के लिए 'बहुत अधिक लागत' का भुगतान किया, कहते हैं कि लोकतंत्र के लिए 'बहुत अधिक लागत' एनआईटीआई अयोध</p>
                    </div> <!-- text-center / end -->
                </a>
            </div> <!-- col-6 / end -->
            <div class='col-md-4'>
